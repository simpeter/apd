...
# Test
curl 'http://localhost:5000/reservation?inDate=2015-04-19&outDate=2015-04-24&lat=nil&lon=nil&hotelId=9&customerName=Cornell_1&username=Cornell_1&password=1111111111&number=1'
curl 'http://localhost:5000/user?username=Cornell_1&password=1111111111'
